    ...
    <View className={`flex-1 ${t.bgPage}`}>
      ...
      {loading ? (
        ...
        <>
          ...
          <TouchableOpacity
            onPress={loadMore}
            className="absolute bottom-20 right-6 bg-blue-600 px-5 py-2 rounded-2xl shadow-lg shadow-blue-500/30"
          >
            <Text className="text-white font-black text-sm">Reload</Text>
          </TouchableOpacity>
          <TouchableOpacity
